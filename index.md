...
We offer the elective *Fundamentos Lógicos da IA* (Logical Foundations of AI), where
students model the same puzzle as SAT, as pseudo-Boolean constraints and as planning,
then compete on the MOJ judge. See [Teaching](teaching.html) for the full description.

## Explore

- [People](people.html)
- [Theses and dissertations](theses.html)
- [Undergraduate research (Iniciação Científica)](research.html)
- [Publications](publications.html)
- [Teaching · FLIA](teaching.html)
